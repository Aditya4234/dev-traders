      ...
      Order.aggregate([
        {
          $group: {
            ...
            lastMonth: { $sum: { $cond: [{ $gte: ["$createdAt", lastMonthStart], $lt: ["$createdAt", startOfMonth] }, 1, 0] } },
            ...
            revenueLastMonth: { $sum: { $cond: [{ $gte: ["$createdAt", lastMonthStart], $lt: ["$createdAt", startOfMonth] }, "$total", 0] } },
          },
        },
      ]),
      Order.aggregate([
